...
export function SearchFilterEnterpriseUser() {
  return (
...
export const MoveTrashButtonFilterTable = () => {
  return (
    <div>
      <button className="filters-EnterpriseUser moveTrashButtonFilterTable">
        Move to Trash
      </button>
    </div>
  );
...
export const DateCreatedButtonFilterTable = () => {
  ...
  return (
    <div>
      <button
        className="filters-EnterpriseUser dateCreatedButtonFilterTable"
        onClick={toggleOrder}
      >
        <BiMenuAltLeft />
        Date Create
...
export const FiltersButtonFilterTable = ({ id }: { id: string }) => {
  ...
  return (
    ...
    >
      <button className="filters-EnterpriseUser">
        <RiMenu5Line />
        Filters
      </button>
...
export const ExportButtonFilterTable = ({ id }: { id: string }) => {
  ...
  return (
    <div
      ...
      className="checkboxButtonFilterTable"
    >
      <button className="filters-EnterpriseUser exportButtonFilterTable">
        Export
        <IoIosArrowDown />
      </button>
